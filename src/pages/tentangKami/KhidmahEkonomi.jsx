...
export default function KhidmahEkonomi() {
  ...
  useEffect(() => {
    ...
    dispatch(getLiteraturByName("khidmah ekonomi"));
  }, [dispatch]);
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Pemberdayaan ekonomi umat melalui program yang berkelanjutan
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        {loading ? (
          <div className="flex justify-center items-center py-16">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Sedang memuat informasi Khidmah Ekonomi...
              </p>
            </div>
          </div>
        ) : error ? (
          <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center">
            ...
            <button
              onClick={() => dispatch(getLiteraturByName("khidmah ekonomi"))}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">
                    Informasi lengkap tentang program ekonomi
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
            ...
            <p className="text-yellow-600">
              Informasi tentang Khidmah Ekonomi belum tersedia saat ini.
            </p>
          </div>
        )}
      </div>
