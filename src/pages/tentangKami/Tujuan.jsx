...
export default function Tujuan() {
  ...
  useEffect(() => {
    ...
    dispatch(getLiteraturByName("tujuan"));
  }, [dispatch]);
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <h1 className="font-bold text-4xl md:text-5xl text-gray-800 mb-4">
              <span className="text-[#69C53E]">Tujuan</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Visi dan misi yang menjadi landasan perjuangan organisasi
            </p>
          </div>
        </div>
      </div>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-16">
            <div className="text-center">
              ...
              <p className="text-gray-600">Sedang memuat informasi Tujuan...</p>
            </div>
          </div>
        ) : error ? (
          <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center">
            ...
            <button
              onClick={() => dispatch(getLiteraturByName("tujuan"))}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">
                    Informasi lengkap tentang tujuan organisasi
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
            ...
            <p className="text-yellow-600">
              Informasi tentang Tujuan belum tersedia saat ini.
            </p>
          </div>
        )}
      </div>
