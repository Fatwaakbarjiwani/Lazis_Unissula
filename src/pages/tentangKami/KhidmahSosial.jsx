...
export default function KhidmahSosial() {
  ...
  useEffect(() => {
    ...
    dispatch(getLiteraturByName("khidmah sosial"));
  }, [dispatch]);
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Bantuan sosial kemanusiaan untuk kesejahteraan masyarakat
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        {loading ? (
          <div className="flex justify-center items-center py-16">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Sedang memuat informasi Khidmah Sosial...
              </p>
            </div>
          </div>
        ) : error ? (
          <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center">
            ...
            <button
              onClick={() => dispatch(getLiteraturByName("khidmah sosial"))}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">
                    Informasi lengkap tentang program sosial kemanusiaan
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
            ...
            <p className="text-yellow-600">
              Informasi tentang Khidmah Sosial belum tersedia saat ini.
            </p>
          </div>
        )}
      </div>
