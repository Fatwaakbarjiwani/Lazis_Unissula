...
export default function Information() {
  ...
  return (
    <div className="flex justify-center font-Inter">
      <div className="absolute top-[22vh] sm:top-[50vh] md:top-[50vh] lg:top-[70vh] flex w-[86%] bg-white shadow shadow-lg rounded-3xl px-1 sm:px-5 md:px-10 lg:px-20 sm:py-5 py-2 transition delay-150 duration-300 ease-in-out">
        <div className="flex w-full justify-around md:justify-between p-2 items-start">
          <div className="flex flex-col items-center justify-between h-full">
            <img src={info4} className="w-10" alt="" />
            <p className="text-green-800 md:text-lg text-[10px] ms:text-sm lg:text-xl">
