...
export default function Information() {
  ...
  return (
    <div className="flex justify-center font-Inter">
      <div className="absolute top-[26vh] sm:top-[35vh] md:top-[40vh] lg:top-[70vh] flex w-[86%] bg-white shadow md:shadow-lg rounded-3xl px-1 sm:px-5 md:px-10 lg:px-20 sm:py-5 py-2 transition delay-150 duration-300 ease-in-out">
